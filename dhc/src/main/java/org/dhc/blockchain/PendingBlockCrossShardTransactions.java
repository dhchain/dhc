...
public class PendingBlockCrossShardTransactions implements Expiring {
	...
	public void expire() {
		if(!list.isEmpty()) {
			logger.info("PendingBlockCrossShardTransactions.expire blockhash={} list.size()={}", blockhash, list.size());
		}
