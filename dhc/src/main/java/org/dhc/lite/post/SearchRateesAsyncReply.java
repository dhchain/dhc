...
public class SearchRateesAsyncReply extends Message {
	...
	public SearchRateesAsyncReply(DhcAddress myAddress, DhcAddress dhcAddress, List<Ratee> ratees) {
	...
	public void process(Peer peer) {
		...
		if(DhcAddress.getMyDhcAddress().equals(myAddress)) {
			SearchRateesEvent event = new SearchRateesEvent(ratees, getCorrelationId());
	...
	public String toString() {
		String str = String.format("SearchRateesAsyncReply %s-%s-%s", myAddress, dhcAddress, getCorrelationId());
		return str;
	}
