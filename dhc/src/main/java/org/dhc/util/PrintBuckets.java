...
public class PrintBuckets {
	...
	public static void main(String[] args) throws Exception {
		PrintBuckets main = new PrintBuckets();
		main.parseArgs(args);
		main.process();
	}
	...
	private void process() throws Exception {
		...
		try (
			...
			Message message = new PrintBucketsMessage();
	...
	private void printUsage(CmdLineParser parser) {
		System.err.println("Usage: java org.dhc.util.PrintBuckets [options...]");
		parser.printUsage(System.err);
		System.err.println("Example: java org.dhc.util.PrintBuckets" + parser.printExample(OptionHandlerFilter.REQUIRED));
		System.exit(-1);
	}
